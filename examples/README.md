...
1. **Data Collection:** Collecting gameplay data using a rule-based agent ([`collect_offline_data.py`](https://github.com/nissymori/mahjax/blob/main/examples/collect_offline_data.py).
...
3. **Reinforcement Learning (RL):** Training a PPO agent with regularization towards the BC model ([`ppo_with_reg.py`](https://github.com/nissymori/mahjax/blob/main/examples/ppo_with_reg.py).
